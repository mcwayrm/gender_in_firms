...
local package_list outreg2 xtabond2 utest tab2xl
...
global cond_if	"if !missing(EQ1, EQ2, GrDivers1, BRemun5, BOwn, TQ, ZScore)"

// Export Cross Tabulation of Sector and Year Composition
tab2xl TRBCEconomicSector year $cond_if ///
	using "${dir_tabs}/composition_by_sector", ///
	row(1) col(1) replace 
