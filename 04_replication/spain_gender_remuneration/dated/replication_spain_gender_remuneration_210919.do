...
twoway (bar brem1 year, color(darkgray%40) base(0) yaxis(1) ylabel(0(50)250) ytick(0(25)250) ytitle("Remuneration Per Director (in Thousands)") xtitle("") ) ///
	...
	(line gd_eea year, lwidth(medthick) yaxis(2) ytick(0(2.5)25, axis(2)) ylabel(0 "0%" 5 "5%" 10 "10%" 15 "15%" 20 "20%" 25 "25%", axis(2)) ytitle("Percentage of Female Directors", axis(2)) lcolor(navy)), ///
	legend(cols(2) pos(6)) ///
	name("plot_rep", replace)

// Export Figure A.1
graph export "${root}\Board Remuneration\Remuneration\figure1.png", ///
		name("plot_rep") replace
