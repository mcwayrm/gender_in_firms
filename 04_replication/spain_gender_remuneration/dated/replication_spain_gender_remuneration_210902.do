...
// Col 1: GD1 BREM1
	reg EQ1 GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
	// VIF Factor
	estat vif
	// FE Censored Regression
	pantob EQ1 GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
...
// Col 2: GD1 BREM2
	reg EQ1 GrDivers1 BRemun9 BRemun92 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
	// VIF Factor
	estat vif
	// FE Censored Regression
	pantob EQ1 GrDivers1 BRemun9 BRemun92 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
...
// Col 3: GD1 BREM3
	reg EQ1 GrDivers1 wBRemun12 wBRemun122 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
	// VIF Factor
	estat vif
	// FE Censored Regression
	pantob EQ1 GrDivers1 wBRemun12 wBRemun122 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
...
// Col 4: GD1 BREM4
	reg EQ1 GrDivers1 wBRemun13 wBRemun132 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
	// VIF Factor
	estat vif
	// FE Censored Regression
	pantob EQ1 GrDivers1 wBRemun13 wBRemun132 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
...
// EM 
	...
	xtabond2 outcome_var GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive, lag(1 3)) 
		estimates store plot_reg_em_gd1
		
	xtabond2 outcome_var GrDivers2 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive, lag(1 3)) 
		estimates store plot_reg_em_gd2
		
	xtabond2 outcome_var GrDivers3 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive, lag(1 3)) 
