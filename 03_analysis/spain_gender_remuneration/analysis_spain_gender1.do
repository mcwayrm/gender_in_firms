...
. pwcorr EQ1 EQ2 EQ3 EQ4 absEM1 GrDivers1 GrDivers2 GrDivers3 GrDivers4 BRemun5 BRemun7 BRemun9 wBRemun10 wBRemun11 wBRemun12 wBRemun13 BRemun14 BRemun14 BOwn BIndependent BSize1 Size wroa wroe leverage1 TQ ZScore if EQ1!=. & GrDivers1!=. & BRemun5!=. & BOwn!=. & EQ2!=. & TQ!=. & ZScore!=., sig star(0.05)
...
*** THIS SET OF ESTIMATIONS CORRESPONDS TO TABLE 4 IN THE PAPER ****
...
**. pantob EQ1 GrDivers1 BRemun7 BRemun72 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
**. pantob EQ1 GrDivers1 wBRemun11 wBRemun112 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
. pantob EQ1 GrDivers1 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
. utest BRemun14 BRemun142 
...
**. pantob EQ1 GrDivers2 BRemun7 BRemun72 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
**. pantob EQ1 GrDivers2 wBRemun11 wBRemun112 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
. pantob EQ1 GrDivers2 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
. utest BRemun14 BRemun142 
...
**. pantob EQ1 GrDivers3 BRemun7 BRemun72 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
**. pantob EQ1 GrDivers3 wBRemun11 wBRemun112 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
. pantob EQ1 GrDivers3 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
. utest BRemun14 BRemun142
...
*** Non-linear regressions with Remuneration. Complete models and GrDivers4***
**. pantob EQ1 GrDivers4 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

**. pantob EQ1 GrDivers4 BRemun7 BRemun72 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

**. pantob EQ1 GrDivers4 BRemun9 BRemun92 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

**. pantob EQ1 GrDivers4 wBRemun11 wBRemun112 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

**. pantob EQ1 GrDivers4 wBRemun12 wBRemun122 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

**. pantob EQ1 GrDivers4 wBRemun13 wBRemun132 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

**. pantob EQ1 GrDivers4 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
*** THIS SET OF ESTIMATIONS CORRESPONDS TO ROBUSTNESS TESTS OF TABLE 4 IN THE PAPER WITH GMM-SE AND DISCRETIONARY ACCRUALS ****
*** Dependent Variable EQ1 ***
*** Non-linear regressions with Remuneration. Complete models and GrDivers1, GrDivers2, and GrDivers3***
. xtabond2 absEM1 GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
...
. xtabond2 absEM1 GrDivers2 BRemun5 BRemun52 BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
...
. xtabond2 absEM1 GrDivers3 BRemun5 BRemun52 BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun5 BRemun52

. xtabond2 absEM1 GrDivers1 BRemun9 BRemun92 BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun9 BRemun92 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun9 BRemun92

. xtabond2 absEM1 GrDivers2 BRemun9 BRemun92 BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun9 BRemun92 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun9 BRemun92

. xtabond2 absEM1 GrDivers3 BRemun9 BRemun92 BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun9 BRemun92 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun9 BRemun92

. xtabond2 absEM1 GrDivers1 BRemun14 BRemun142 BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun14 BRemun142 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun14 BRemun142

. xtabond2 absEM1 GrDivers2 BRemun14 BRemun142 BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun14 BRemun142 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun14 BRemun142

. xtabond2 absEM1 GrDivers3 BRemun14 BRemun142 BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun14 BRemun142 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun14 BRemun142
...
*** THIS SET OF ESTIMATIONS CORRESPONDS TO TABLE 5 IN THE PAPER ****
...
**. pantob EQ2 GrDivers1 BRemun7 BRemun72 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
...
**. pantob EQ2 GrDivers1 BRemun9 BRemun92 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers1 wBRemun11 wBRemun112 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers1 wBRemun12 wBRemun122 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers1 wBRemun13 wBRemun132 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers1 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat
...
**. pantob EQ2 GrDivers2 BRemun7 BRemun72 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers2 BRemun9 BRemun92 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers2 wBRemun11 wBRemun112 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers2 wBRemun12 wBRemun122 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers2 wBRemun13 wBRemun132 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers2 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat
...
**. pantob EQ2 GrDivers3 BRemun7 BRemun72 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers3 BRemun9 BRemun92 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers3 wBRemun11 wBRemun112 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers3 wBRemun12 wBRemun122 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers3 wBRemun13 wBRemun132 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers3 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat
...
*** Non-linear regressions with Remuneration. Complete models and GrDivers4***
**. pantob EQ2 GrDivers4 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers4 BRemun7 BRemun72 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers4 BRemun9 BRemun92 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers4 wBRemun11 wBRemun112 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers4 wBRemun12 wBRemun122 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers4 wBRemun13 wBRemun132 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat

**. pantob EQ2 GrDivers4 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
**. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ2") dec(4)  tstat




*** THIS SET OF ESTIMATIONS CORRESPONDS TO ROBUSTNESS TESTS OF TABLES 4 AND 5 IN THE PAPER WITH GMM-SE ****
*** Dependent Variable EQ2 ***
*** Non-linear regressions with Remuneration. Complete models and GrDivers1, GrDivers2, and GrDivers3 ******
. xtabond2 EQ2 GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", replace label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun5 BRemun52

. xtabond2 EQ2 GrDivers2 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun5 BRemun52

. xtabond2 EQ2 GrDivers3 BRemun5 BRemun52 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun5 BRemun52 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun5 BRemun52

. xtabond2 EQ2 GrDivers1 BRemun9 BRemun92 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun9 BRemun92 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun9 BRemun92

. xtabond2 EQ2 GrDivers2 BRemun9 BRemun92 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun9 BRemun92 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun9 BRemun92

. xtabond2 EQ2 GrDivers3 BRemun9 BRemun92 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun9 BRemun92 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun9 BRemun92

. xtabond2 EQ2 GrDivers1 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun14 BRemun142 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun14 BRemun142

. xtabond2 EQ2 GrDivers2 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun14 BRemun142 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun14 BRemun142

. xtabond2 EQ2 GrDivers3 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun14 BRemun142 BOwn BIndependent BSeparatPw BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun14 BRemun142
...
*** THIS SET OF ESTIMATIONS CORRESPONDS TO ROBUSTNESS TESTS OF TABLE 4, 5, AND 6 IN THE PAPER WITH GMM-SE ****
*** Dependent Variable EQ1, EQ2, EQ3 and EQ4 ***
*** Non-linear regressions with Remuneration. Complete models and GrDivers1***
...
*** THIS SET OF ESTIMATIONS CORRESPONDS TO ROBUSTNESS TESTS OF TABLE 4, 5, AND 6 IN THE PAPER WITH GMM-SE ****
*** Dependent Variable absEM1 multiplied by -1 ***
*** Non-linear regressions with Remuneration. Complete models and GrDivers1, GrDivers2 and GrDivers3***
...
. xtabond2 absEM1 GrDivers1 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers1 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun14 BRemun142

. xtabond2 absEM1 GrDivers2 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers2 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun14 BRemun142

. xtabond2 absEM1 GrDivers3 BRemun14 BRemun142 BOwn BIndependent BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3, small twostep gmm(GrDivers3 BRemun14 BRemun142 BIndependent BSize1 BExecutive, lag(1 3)) 
. outreg2 using "GMM.xls", append label addtext(Year FE, YES, Industry FE, YES) addstat(Instruments, e(j), Avrg. Obs. per Group, e(g_avg), AR(1), e(ar1), p-value, e(ar1p), AR(2), e(ar2), p-value, e(ar2p), Sargan, e(sargan), F-test, e(F)) dec(4)
. utest BRemun14 BRemun142
...
***** THIS SET OF ESTIMATIONS CORRESPOND TO THE COMPARISON BETWEEN IBEX AND NON-IBEX COMPANIES *****
***** QUADRATIC FORM *****
. generate GrDivers1IBEX=GrDivers1*IBEX
. generate BRemun5IBEX=BRemun5*IBEX
. generate BRemun52IBEX=BRemun52*IBEX

. pantob EQ1 GrDivers1 GrDivers1IBEX BRemun5 BRemun5IBEX BRemun52 BRemun52IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", replace addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers1+GrDivers1IBEX
. lincom  BRemun5+BRemun5IBEX
. lincom  BRemun52+BRemun52IBEX

. generate BRemun9IBEX=BRemun9*IBEX
. generate BRemun92IBEX=BRemun92*IBEX

. pantob EQ1 GrDivers1 GrDivers1IBEX BRemun9 BRemun9IBEX BRemun92 BRemun92IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers1+GrDivers1IBEX
. lincom  BRemun9+BRemun9IBEX
. lincom  BRemun92+BRemun92IBEX

. generate wBRemun12IBEX=wBRemun12*IBEX
. generate wBRemun122IBEX=wBRemun122*IBEX

. pantob EQ1 GrDivers1 GrDivers1IBEX wBRemun12 wBRemun12IBEX wBRemun122 wBRemun122IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers1+GrDivers1IBEX
. lincom  wBRemun12+wBRemun12IBEX
. lincom  wBRemun122+wBRemun122IBEX

. generate wBRemun13IBEX=wBRemun13*IBEX
. generate wBRemun132IBEX=wBRemun132*IBEX

. pantob EQ1 GrDivers1 GrDivers1IBEX wBRemun13 wBRemun13IBEX wBRemun132 wBRemun132IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers1+GrDivers1IBEX
. lincom  wBRemun13+wBRemun13IBEX
. lincom  wBRemun132+wBRemun132IBEX

. generate BRemun14IBEX=BRemun14*IBEX
. generate BRemun142IBEX=BRemun142*IBEX

. pantob EQ1 GrDivers1 GrDivers1IBEX BRemun14 BRemun14IBEX BRemun142 BRemun142IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers1+GrDivers1IBEX
. lincom  BRemun14+BRemun14IBEX
. lincom  BRemun142+BRemun142IBEX

. generate GrDivers2IBEX=GrDivers2*IBEX

. pantob EQ1 GrDivers2 GrDivers2IBEX BRemun5 BRemun5IBEX BRemun52 BRemun52IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers2+GrDivers2IBEX
. lincom  BRemun5+BRemun5IBEX
. lincom  BRemun52+BRemun52IBEX

. pantob EQ1 GrDivers2 GrDivers2IBEX BRemun9 BRemun9IBEX BRemun92 BRemun92IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
. pantob EQ1 GrDivers2 GrDivers2IBEX wBRemun12 wBRemun12IBEX wBRemun122 wBRemun122IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
. pantob EQ1 GrDivers2 GrDivers2IBEX wBRemun13 wBRemun13IBEX wBRemun132 wBRemun132IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
. pantob EQ1 GrDivers2 GrDivers2IBEX BRemun14 BRemun14IBEX BRemun142 BRemun142IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
. generate GrDivers3IBEX=GrDivers3*IBEX

. pantob EQ1 GrDivers3 GrDivers3IBEX BRemun5 BRemun5IBEX BRemun52 BRemun52IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers3+GrDivers3IBEX
. lincom  BRemun5+BRemun5IBEX
. lincom  BRemun52+BRemun52IBEX

. pantob EQ1 GrDivers3 GrDivers3IBEX BRemun9 BRemun9IBEX BRemun92 BRemun92IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
. pantob EQ1 GrDivers3 GrDivers3IBEX wBRemun12 wBRemun12IBEX wBRemun122 wBRemun122IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
. pantob EQ1 GrDivers3 GrDivers3IBEX wBRemun13 wBRemun13IBEX wBRemun132 wBRemun132IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
. pantob EQ1 GrDivers3 GrDivers3IBEX BRemun14 BRemun14IBEX BRemun142 BRemun142IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
...
**** LINEAR FORM *****
. pantob EQ1 GrDivers1 GrDivers1IBEX BRemun5 BRemun5IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", replace addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers1+GrDivers1IBEX
. lincom  BRemun5+BRemun5IBEX

. pantob EQ1 GrDivers1 GrDivers1IBEX BRemun9 BRemun9IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers1+GrDivers1IBEX
. lincom  BRemun9+BRemun9IBEX

. pantob EQ1 GrDivers1 GrDivers1IBEX wBRemun12 wBRemun12IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers1+GrDivers1IBEX
. lincom  wBRemun12+wBRemun12IBEX

. pantob EQ1 GrDivers1 GrDivers1IBEX wBRemun13 wBRemun13IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers1+GrDivers1IBEX
. lincom  wBRemun13+wBRemun13IBEX

. pantob EQ1 GrDivers1 GrDivers1IBEX BRemun14 BRemun14IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers1+GrDivers1IBEX
. lincom  BRemun14+BRemun14IBEX

. pantob EQ1 GrDivers2 GrDivers2IBEX BRemun5 BRemun5IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers2+GrDivers2IBEX
. lincom  BRemun5+BRemun5IBEX

. pantob EQ1 GrDivers2 GrDivers2IBEX BRemun9 BRemun9IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers2+GrDivers2IBEX
. lincom  BRemun9+BRemun9IBEX

. pantob EQ1 GrDivers2 GrDivers2IBEX wBRemun12 wBRemun12IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers2+GrDivers2IBEX
. lincom  wBRemun12+wBRemun12IBEX

. pantob EQ1 GrDivers2 GrDivers2IBEX wBRemun13 wBRemun13IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers2+GrDivers2IBEX
. lincom  wBRemun13+wBRemun13IBEX

. pantob EQ1 GrDivers2 GrDivers2IBEX BRemun14 BRemun14IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers2+GrDivers2IBEX
. lincom  BRemun14+BRemun14IBEX

. pantob EQ1 GrDivers3 GrDivers3IBEX BRemun5 BRemun5IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers3+GrDivers3IBEX
. lincom  BRemun5+BRemun5IBEX

. pantob EQ1 GrDivers3 GrDivers3IBEX BRemun9 BRemun9IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers3+GrDivers3IBEX
. lincom  BRemun9+BRemun9IBEX

. pantob EQ1 GrDivers3 GrDivers3IBEX wBRemun12 wBRemun12IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers3+GrDivers3IBEX
. lincom  wBRemun12+wBRemun12IBEX

. pantob EQ1 GrDivers3 GrDivers3IBEX wBRemun13 wBRemun13IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat

. lincom  GrDivers3+GrDivers3IBEX
. lincom  wBRemun13+wBRemun13IBEX

. pantob EQ1 GrDivers3 GrDivers3IBEX BRemun14 BRemun14IBEX BOwn BIndependent BSeparatPw BSize1 BExecutive Size wZScore wroa leverage1 TQ factor1 factor2 factor3 Iden
. outreg2 using "PANTOB.xls", append addtext(Year/Ind FE, YES) title("Table 1. Earnings Quality: Censored Models with FE (Pantob)") ctitle("EQ1") dec(4)  tstat
